...
<div data-role="page" id="inicio">
	...
	<div class="informacion-ne3 col-md-12 text-center">
		...
		<div id="noMeRegistro"><a href="#principal"><span>CONTINUAR</span></a></div>
...
<div data-role="page" id="principal">
	...
	<div data-role="panel" id="mypanel">
			...
			<ul class="row">	    		
				...
				<li class="col-md-12 col-sm-12 col-xs-12 text-center"><a href="#" onclick="window.open('https://itunes.apple.com/ec/app/bsc-fan/id1038325597?mt=8', '_system');"><i class="fa fa-bscFan fa-2x"></i><span>BSC FAN</span></a></li>
...
<div data-role="page" id="proximopartido">
	...
	<div data-role="content">
		<div class="ads-proximo1" onclick="window.open('https://itunes.apple.com/ec/app/bsc-fan/id1038325597?mt=8', '_system');"></div>
		<div class="cancha-vs">
	...
	<div data-role="footer" data-position="fixed" data-tap-toggle="false" class="footer-bsc">
		<div class="ads-proximo2" onclick="window.open('https://itunes.apple.com/ec/app/bsc-fan/id1038325597?mt=8', '_system');"></div>
		<!--<div class="logoMini"></div>-->
	</div><!-- /footer -->
</div><!-- /page -->
...
<div data-role="page" id="distribucion">
	...
	<div data-role="footer" data-position="fixed" data-tap-toggle="false" class="footer-bsc">
		<div class="ads-distribucion1" onclick="window.open('https://itunes.apple.com/ec/app/bsc-fan/id1038325597?mt=8', '_system');"></div>
		<!--<div class="logoMini"></div>-->
	</div><!-- /footer -->
</div><!-- /page -->
...
<div data-role="page" id="minuto">
	...
	<div data-role="footer" data-position="fixed" data-tap-toggle="false" class="footer-bsc">
		<div class="ads-minuto1" onclick="window.open('https://itunes.apple.com/ec/app/bsc-fan/id1038325597?mt=8', '_system');"></div>
		<!--<div class="logoMini"></div>-->
	</div><!-- /footer -->
</div><!-- /page -->
...
<div data-role="page" id="descargas">
	...
	<div data-role="footer" data-position="fixed" data-tap-toggle="false" class="footer-bsc">
		...
		<!--<script type="text/javascript" src="http://code.vostrel.cz/jquery.reel.js"></script>-->
